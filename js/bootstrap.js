...
+function($) {
                ...
                Alert, [
                    {
                        ...
                        key: '_removeElement', value: function _removeElement(element) {
                            ...
                            $(element).one(Util.TRANSITION_END, $.proxy(this._destroyElement, this, element))
    ...
    var Carousel = (function($) {
        ...
        var ClassName = {
            CAROUSEL: 'carousel', ACTIVE: 'active', SLIDE: 'slide', RIGHT: 'right', LEFT: 'left', ITEM: 'carousel-item'
        };
                ...
                Carousel, [
                    {
                        ...
                        key: 'nextWhenVisible', value: function nextWhenVisible() {
                        ...
                        key: '_addEventListeners', value: function _addEventListeners() {
                            ...
                            if (this._config.pause === 'hover' && !('ontouchstart' in document.documentElement)) {
                                $(this._element).on(Event.MOUSEENTER, $.proxy(this.pause, this)).on(
                                    Event.MOUSELEAVE, $.proxy(
                                        this.cycle, this
                                    )
                                );
                            }
                        ...
                        value: function _triggerSlideEvent(relatedTarget, directionalClassname) {
                            var slideEvent = $.Event(
                                Event.SLIDE, {
                                    relatedTarget: relatedTarget, direction: directionalClassname
                                }
                            );
                        ...
                        key: '_slide', value: function _slide(direction, element) {
                            ...
                            var slidEvent = $.Event(
                                Event.SLID, {
                                    relatedTarget: nextElement, direction: directionalClassName
                                }
                            );
                            ...
                            if (Util.supportsTransitionEnd() && $(this._element).hasClass(ClassName.SLIDE)) {
                                ...
                                $(activeElement).one(
                                    Util.TRANSITION_END, function() {
                                        ...
                                        $(activeElement).removeClass(ClassName.ACTIVE).removeClass(direction)
    ...
    var Collapse = (function($) {
        ...
        var ClassName = {
            IN: 'in', COLLAPSE: 'collapse', COLLAPSING: 'collapsing', COLLAPSED: 'collapsed'
        };
        ...
        var Selector = {
            ACTIVES: '.panel > .in, .panel > .collapsing', DATA_TOGGLE: '[data-toggle="collapse"]'
        };
                ...
                Collapse, [
                    {
                        ...
                        key: 'show', value: function show() {
                            ...
                            var complete = function complete() {
                                $(_this4._element).removeClass(ClassName.COLLAPSING).addClass(ClassName.COLLAPSE)
                            ...
                            $(this._element).one(Util.TRANSITION_END, complete).emulateTransitionEnd(
                                TRANSITION_DURATION
                            );
                        ...
                        key: 'hide', value: function hide() {
                            ...
                            $(this._element).addClass(ClassName.COLLAPSING).removeClass(ClassName.COLLAPSE).removeClass(
                                ClassName.IN
                            );
                            ...
                            var complete = function complete() {
                                ...
                                $(_this5._element).removeClass(ClassName.COLLAPSING).addClass(ClassName.COLLAPSE)
                        ...
                        value: function _addAriaAndCollapsedClass(element, triggerArray) {
                            if (element) {
                                ...
                                if (triggerArray.length) {
                                    $(triggerArray).toggleClass(ClassName.COLLAPSED, !isOpen).attr(
                        ...
                        key: '_jQueryInterface', value: function _jQueryInterface(config) {
                            return this.each(
                                function() {
                                    ...
                                    var data = $this.data(DATA_KEY);
                                    var _config = $.extend(
                                        {}, Default, $this.data(), typeof config === 'object' && config
                                    );
    ...
    var Dropdown = (function($) {
        ...
        var ClassName = {
            BACKDROP: 'dropdown-backdrop', DISABLED: 'disabled', OPEN: 'open'
        };
        ...
        $(document).on(Event.KEYDOWN_DATA_API, Selector.DATA_TOGGLE, Dropdown._dataApiKeydownHandler).on(
            Event.KEYDOWN_DATA_API, Selector.ROLE_MENU, Dropdown._dataApiKeydownHandler
        ).on(Event.KEYDOWN_DATA_API, Selector.ROLE_LISTBOX, Dropdown._dataApiKeydownHandler).on(
            Event.CLICK_DATA_API, Dropdown._clearMenus
                ...
                Modal, [
                    {
                        ...
                        key: 'hide', value: function hide(event) {
                            ...
                            if (Util.supportsTransitionEnd() && $(this._element).hasClass(ClassName.FADE)) {
                                ...
                                $(this._element).one(Util.TRANSITION_END, $.proxy(this._hideModal, this))
                                .emulateTransitionEnd(TRANSITION_DURATION);
                            } else {
                                this._hideModal();
                            }
                        ...
                        key: '_showElement', value: function _showElement(relatedTarget) {
                            ...
                            if (transition) {
                                $(this._dialog).one(Util.TRANSITION_END, transitionComplete).emulateTransitionEnd(
                                    TRANSITION_DURATION
                                );
                            } else {
                                transitionComplete();
                        ...
                        key: '_enforceFocus', value: function _enforceFocus() {
                            ...
                            .on(
                                Event.FOCUSIN, function(event) {
                                    if (_this9._element !== event.target &&
                        ...
                        key: '_showBackdrop', value: function _showBackdrop(callback) {
                            ...
                            if (this._isShown && this._config.backdrop) {
                                ...
                                $(this._backdrop).one(Util.TRANSITION_END, callback).emulateTransitionEnd(
                ...
                ], [
                    {
                        ...
                        return this.each(
                            function() {
                                var data = $(this).data(DATA_KEY);
                                var _config = $.extend(
                                    {}, Modal.Default, $(this).data(), typeof config === 'object' && config
                                );
                ...
                ScrollSpy, [
                    {
                        ...
                        key: '_getScrollTop', value: function _getScrollTop() {
                            return this._scrollElement === window ? this._scrollElement.scrollY :
                        ...
                        key: '_activate', value: function _activate(target) {
                            ...
                            if ($link.hasClass(ClassName.DROPDOWN_ITEM)) {
                                $link.closest(Selector.DROPDOWN).find(Selector.DROPDOWN_TOGGLE).addClass(
                                    ClassName.ACTIVE
                                );
    ...
    var Tab = (function($) {
        ...
        var ClassName = {
            DROPDOWN_MENU: 'dropdown-menu', ACTIVE: 'active', FADE: 'fade', IN: 'in'
        };
                ...
                Tab, [
                    {
                        ...
                        key: '_activate', value: function _activate(element, container, callback) {
                            ...
                            var complete = $.proxy(
                                this._transitionComplete, this, element, active, isTransitioning, callback
                            );
                        ...
                        key: '_setListeners', value: function _setListeners() {
                            ...
                            triggers.forEach(
                                function(trigger) {
                                    if (trigger === 'click') {
                                        $(_this18.element).on(
                                            _this18.constructor.Event.CLICK, _this18.config.selector,
                                            $.proxy(_this18.toggle, _this18)
                                        );
                                    } else if (trigger !== Trigger.MANUAL) {
                                        var eventIn = trigger === Trigger.HOVER ? _this18.constructor.Event.MOUSEENTER :
                                            _this18.constructor.Event.FOCUSIN;
                                        var eventOut = trigger === Trigger.HOVER ?
                                            _this18.constructor.Event.MOUSELEAVE : _this18.constructor.Event.FOCUSOUT;

                                        $(_this18.element).on(
                                            eventIn, _this18.config.selector, $.proxy(_this18._enter, _this18)
    ...
    var Popover = (function($) {
        ...
        var Selector = {
            TITLE: '.popover-title', CONTENT: '.popover-content', ARROW: '.popover-arrow'
        };
                ...
                Popover, [
                    {
                        ...
                        key: '_getContent', value: function _getContent() {
                            return this.element.getAttribute('data-content') ||
                                (typeof this.config.content === 'function' ? this.config.content.call(this.element) :
                                    this.config.content);
                        }
