                    ...
                    Modal, [
                        {
                            ...
                            key: 'show', value: function show(relatedTarget) {
                                ...
                                $(this._element).on(
                                    Event.CLICK_DISMISS, Selector.DATA_DISMISS, $.proxy(this.hide, this)
                                );
                            ...
                            key: 'hide', value: function hide(event) {
                                ...
                                if (_Util['default'].supportsTransitionEnd() &&
                                    ...
                                    $(this._element).one(
                                        _Util['default'].TRANSITION_END, $.proxy(this._hideModal, this)
                            ...
                            key: '_showElement', value: function _showElement(relatedTarget) {
                                ...
                                var transition = _Util['default'].supportsTransitionEnd() &&
                                    $(this._element).hasClass(ClassName.FADE);
                                ...
                                if (transition) {
                                    $(this._dialog).one(_Util['default'].TRANSITION_END, transitionComplete)
                                    .emulateTransitionEnd(TRANSITION_DURATION);
                                } else {
                                    transitionComplete();
                                }
                            ...
                            key: '_enforceFocus', value: function _enforceFocus() {
                                ...
                                .on(
                                    Event.FOCUSIN, function(event) {
                                        if (_this3._element !== event.target &&
                            ...
                            key: '_showBackdrop', value: function _showBackdrop(callback) {
                                ...
                                if (this._isShown && this._config.backdrop) {
                                    ...
                                    $(this._backdrop).one(_Util['default'].TRANSITION_END, callback)
                                    ...
                                    if (_Util['default'].supportsTransitionEnd() &&
                                        $(this._element).hasClass(ClassName.FADE)) {
                                        $(this._backdrop).one(_Util['default'].TRANSITION_END, callbackRemove)
                                        .emulateTransitionEnd(BACKDROP_TRANSITION_DURATION);
                                    } else {
                                        callbackRemove();
                                    }
