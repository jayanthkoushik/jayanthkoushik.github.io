                    ...
                    Carousel, [
                        {
                            ...
                            key: 'pause', value: function pause(event) {
                                ...
                                if ($(this._element).find(Selector.NEXT_PREV)[0] &&
                                    _Util['default'].supportsTransitionEnd()) {
                            ...
                            key: '_addEventListeners', value: function _addEventListeners() {
                                ...
                                if (this._config.pause === 'hover' && !('ontouchstart' in document.documentElement)) {
                                    $(this._element).on(Event.MOUSEENTER, $.proxy(this.pause, this)).on(
                                        Event.MOUSELEAVE, $.proxy(this.cycle, this)
                                    );
                                }
                            }
                        }, {
                            ...
                            key: '_slide', value: function _slide(direction, element) {
                                ...
                                var directionalClassName = direction === Direction.NEXT ? ClassName.LEFT :
                                    ClassName.RIGHT;
                                ...
                                if (_Util['default'].supportsTransitionEnd() &&
                                    ...
                                    $(activeElement).one(
                                        _Util['default'].TRANSITION_END, function() {
