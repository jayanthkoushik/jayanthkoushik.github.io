                    ...
                    Tooltip, [
                        {
                            ...
                            key: 'show', value: function show() {
                                ...
                                if (this.isWithContent() && this._isEnabled) {
                                    ...
                                    if (_Util['default'].supportsTransitionEnd() &&
                                        ...
                                        $(this.tip).one(_Util['default'].TRANSITION_END, complete).emulateTransitionEnd(
                            ...
                            key: 'hide', value: function hide(callback) {
                                ...
                                if (_Util['default'].supportsTransitionEnd() && $(this.tip).hasClass(ClassName.FADE)) {
                                    ...
                                    $(tip).one(_Util['default'].TRANSITION_END, complete).emulateTransitionEnd(
                                        TRANSITION_DURATION
                                    );
                                } else {
                                    complete();
                            ...
                            key: 'getTitle', value: function getTitle() {
                                ...
                                if (!title) {
                                    title =
                                        typeof this.config.title === 'function' ? this.config.title.call(this.element) :
                                            this.config.title;
                                }
                            ...
                            key: '_setListeners', value: function _setListeners() {
                                ...
                                triggers.forEach(
                                    function(trigger) {
                                        if (trigger === 'click') {
                                            $(_this3.element).on(
                                                _this3.constructor.Event.CLICK, _this3.config.selector,
                                                $.proxy(_this3.toggle, _this3)
                                            );
                                        } else if (trigger !== Trigger.MANUAL) {
                                            var eventIn = trigger === Trigger.HOVER ?
                                                _this3.constructor.Event.MOUSEENTER : _this3.constructor.Event.FOCUSIN;
                                            var eventOut = trigger === Trigger.HOVER ?
                                                _this3.constructor.Event.MOUSELEAVE : _this3.constructor.Event.FOCUSOUT;

                                            $(_this3.element).on(
                                                eventIn, _this3.config.selector, $.proxy(_this3._enter, _this3)
                                            ).on(eventOut, _this3.config.selector, $.proxy(_this3._leave, _this3));
                                        }
                                    }
                                );
